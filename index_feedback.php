         ...
         <nav class="navbar navbar-expand-md navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="toggleMobileMenu">
               <ul class="navbar-nav ms-auto">
                  <li class="nav-item">
                     <a class="nav-link active pe-3" aria-current="page" href="admin_page.php">L</a>
                  </li>
               </ul>
            </div>
            </div>
         ...
         <table class="table table-dark">
         	...
         	<tbody class="align-middle">
         			<?php for ($i=0; $i < $jumlah ; $i++) { 
         				...
         				echo "<td><input type='text' readonly class='form-control-plaintext text-white' id='staticEmail' value='"."FEEDS00".$datagambar[$i]["id"]."'></td>";
         				echo "<td>".$datagambar[$i]["nama_subject"]."</td>";
