         ...
         <table class="table table-dark">
         	...
         	<tbody class="align-middle">
         			<?php for ($i=0; $i < $jumlah ; $i++) { 
         				...
         				echo "<td><input type='text' readonly class='form-control-plaintext text-white' id='staticEmail' value='"."REQ00".$datagambar[$i]["id"]."'></td>";
         				echo "<td>".$datagambar[$i]["nama_peminta"]."</td>";
