                  ...
                  <div class="tabset">
                     ...
                     <div class="tab-panels">
                        <section id="Lapor" class="tab-panel text-white">
                           ...
                           <!-- <p class="head">Nama</p> -->
                           <p><input placeholder="Nama" type="text" name="Nama.P" size="40" id="NamaP"></p>
                           <!-- <p class="head">Surel</p> -->
                           <p><input placeholder="Surel" type="text" name="email" size="40" id="EmailP"></p>
                           <!-- <p class="head">Deskripsi Laporan</p> -->
                           <p><textarea placeholder="Deskripsi Laporan" rows="7" cols="40" name="teks.l" id="DeskP"><?php echo $laporan; ?></textarea></p>
                           <a class="button" style="position: absolute; left:38%;top: 70%;" id="btnPesan">Submit</a>
                        </section>
                        ...
                        <section id="Permintaan" class="tab-panel">
                           ...
                           <!-- <p class="head">Nama</p> -->
                           <p><input placeholder="Nama" type="text" name="Nama.P" size="40" id="NamaK"></p>
                           <!-- <p class="head">Surel</p> -->
                           <p><input placeholder="Surel" type="text" name="email" size="40" id="EmailK"></p>
                           <!-- <p class="head">Deskripsi Laporan</p> -->
                           <p><textarea placeholder="Deskripsi Permintaan" rows="7" cols="40" name="teks.l" id="DeskK"></textarea></p>
                        ...
                        <section id="PesanKesan" class="tab-panel">
                           ...
                           <!-- <p class="head">Nama</p> -->
                           <p><input placeholder="Nama" type="text" name="Nama.P" size="40" id="NamaD"></p>
                           <!-- <p class="head">Surel</p> -->
                           <p><input placeholder="Surel" type="text" name="email" size="40" id="EmailD"></p>
                           <!-- <p class="head">Deskripsi Laporan</p> -->
                           <p><textarea placeholder="Pesan" rows="7" cols="40" name="teks.l" id="DeskD"></textarea></p>
